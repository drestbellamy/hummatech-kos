...
class AddRuleCategoryDialog extends StatefulWidget {
  const AddRuleCategoryDialog({super.key});

  @override
  State<AddRuleCategoryDialog> createState() => _AddRuleCategoryDialogState();
}

class _AddRuleCategoryDialogState extends State<AddRuleCategoryDialog> {
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          hintText: 'Contoh: Jam Malam & Keamanan',
                          hintStyle: TextStyle(
